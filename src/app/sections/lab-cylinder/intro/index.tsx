        ...
        <p className="subtitle">
          ...
          >
            ...
            />
              ...
              Embark on a journey to Explore the enigmatic wonders,
              Mystify your senses, and Evoke creativity by being part of our events.
              </p>

        <div className="marquees">
          <Marquee className={"marquee1"} orange />
          <Marquee className={"marquee2"} reverse />
...
const Marquee = ({
  ...
  return (
    <div
      className={clsx("marqueeContainer", className)}
      style={{
    ...
    >
      <div
        className={clsx("marqueeAnimationContainer", reverse && reverse)}
